...
const answers = [
  { word: "cartilago thyroidea", abbreviations: [""] },
  { word: "Os hyoideum", abbreviations: [""] },
  { word: "Membrana thyroidea", abbreviations: [""] },
  { word: "Incisura thyroidea superior", abbreviations: [""] },
  { word: "Corpus ossis hyoidei", abbreviations: [""] },
  { word: "Ligamentum thyrohyoideum medianum", abbreviations: ["Lig. thyrohyoideum medianum"] },
  { word: "", abbreviations: [""] },
  { word: "Cornu superius cartlaginis thyroideae", abbreviations: ["Cornu superius"] },
  { word: "Cornu majus", abbreviations: [""] },
  { word: "Ligamentum thyrohyoideum laterale", abbreviations: ["Lig. thyrohyoideum laterale"] },
  { word: "Cartilago triticea", abbreviations: [""] },
  { word: "Ligamentum cricothyroideum medianum", abbreviations: ["Lig. cricothyroideum medianum"] },
  { word: "Conus elasticus", abbreviations: [""] },
  { word: "Ligamentum cricotracheale", abbreviations: ["Lig. cricotracheale"] },
  { word: "Ligamentum thyroepiglotticum", abbreviations: ["Lig. thyroepiglotticum"] },
  { word: "Ligamentum hyoepiglotticum", abbreviations: ["Lig. hyoepiglotticum"] },
  { word: "Articulatio cricothyroidea", abbreviations: [""] },
