...
<body>
    ...
    <div><h1 style="font-size: 40px; font-weight:400; margin: 1%;">Muskeln des Ellenbogengelenks<h1></div>
    ...
    <p id="instructions">Beginne damit, die Muskeln des Ellenbogengelnks zu benennen.</p>
