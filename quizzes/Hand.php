        ...
        <main>
            <div class="quizFrame">
                    ...
                    <div class="pictureFrame">
                        <img class="quizPicture" src="../bilder/Hand palmar.png" oncontextmenu="return false;">
                        

                        <div class="label" style="left: 293px; top: 170px;">1</div>

                        <div class="line" style="top: 194px; transform: translateX(165px) rotate(0deg); width: 40px;"></div>
                        <div class="label" style="left: 195px; top: 176px;">2</div>

                        <div class="label" style="left: 290px; top: 235px;">3</div>

                        <div class="label" style="left: 289px; top: 330px;">4</div>
                        ...
                        <div class="label" style="left: 440px; top: 250px;">5</div>

                        <div class="line" style="top: 305px; transform: translateX(100px) rotate(0deg); width: 40px;"></div>
                        <div class="label" style="left: 125px; top: 289px;">6</div>
                        ...
                        <div class="line" style="top: 498px; transform: translateX(353px) rotate(0deg); width: 20px;"></div>
                ...
                <div class="answerFrame">
                    ...
                    <div class="answerTop">
                    <div><h1 style="font-size: 40px; font-weight:400;">Hand<h1></div>
