        ...
        <main>
            <div class="quizFrame">
                    ...
                    <div class="pictureFrame">
                        ...
                        <div class="label" data-number="1" onclick="selectNumber(1)" style="left: 370px; top: 450px;">1</div>
                        <div class="label" data-number="2" onclick="selectNumber(2)" style="left: 410px; top: 255px;">2</div>
                        <div class="line" style="top: 550px; transform: translateX(305px)rotate(90deg); width: 45px;"></div>
                        <div class="label" data-number="3" onclick="selectNumber(3)" style="left: 315px; top: 570px;">3</div>
                        <div class="line" style="top: 197px; transform: translateX(285px) rotate(25deg); width: 45px;"></div>
                        <div class="label"data-number="4" onclick="selectNumber(4)" style="left: 260px; top: 160px;">4</div>
                        <div class="line" style="top: 424px; transform: translateX(47px) rotate(90deg); width: 60px;"></div>
                        <div class="label" data-number="5" onclick="selectNumber(5)" style="left: 65px; top: 450px;">5</div>
                        <div class="label" data-number="6" onclick="selectNumber(6)" style="left: 94px; top: 355px;">6</div>
                        <div class="line"  style="top: 315px; transform: translateX(120px) rotate(75deg); width: 60px;"></div>
                        <div class="label" data-number="7" onclick="selectNumber(7)" style="left: 130px; top: 250px;">7</div>
                        <div class="label" data-number="8" onclick="selectNumber(8)" style="left: 315px; top: 300px;">8</div>
                        ...
                        <div class="label" data-number="9" onclick="selectNumber(9)" style="left: 315px; top: 350px;">9</div>
                        <div class="line" style="top: 455px; transform: translateX(310px) rotate(90deg); width: 35px;"></div>
                        <div class="label" data-number="10" onclick="selectNumber(10)" style="left: 310px; top: 405px;">10</div>
                        <div class="line" style="top: 300px; transform: translateX(464px) rotate(-35deg); width: 35px;"></div>
                        <div class="label" data-number="11" onclick="selectNumber(11)" style="left: 495px; top: 260px;">11</div>
                    </div>
                
                <div class="answerFrame">

                    <div class="answerTop">
                    <div><h1 style="font-size: 40px; font-weight:400;">Atlas<h1></div>
