...
<body>
    ...
    <table class="tabelle" id="RotatorenmanschetteErgebnisse">
      ...
      <button class="check-button" id="previous" onclick="window.location.replace('FussMuskeln.php')"> <<  Vorheriges Quiz </button>
      <button class="check-button" id="next" onclick="window.location.replace('SchulterweitereMuskeln.php')"> Nächstes  Quiz >></button>
