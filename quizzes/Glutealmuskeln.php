...
<body>
    ...
    <div><h1 style="font-size: 40px; font-weight:400; margin: 1%; cursor: pointer;" onclick="window.location.replace('/MuskelAuswahl.php')">Glutealmuskeln<h1></div>
    ...
    <table class="tabelle" id="MuskelnErgebnisse">
      ...
      <button class="check-button" id="previous" onclick="window.location.replace('Handmuskeln.php')"> <<  Vorheriges Quiz </button>
      <button class="check-button" id="next" onclick="window.location.replace('PelvitrochantaereMuskulatur.php')"> Nächstes  Quiz >></button>
